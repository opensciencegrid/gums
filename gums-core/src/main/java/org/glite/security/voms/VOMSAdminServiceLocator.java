...
public class VOMSAdminServiceLocator extends org.apache.axis.client.Service implements org.glite.security.voms.VOMSAdminService {
    ...
    public org.glite.security.voms.VOMSAdmin getVOMSAdmin() throws javax.xml.rpc.ServiceException {
    ...
    public org.glite.security.voms.VOMSAdmin getVOMSAdmin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.glite.security.voms.VOMSAdminSoapBindingStub _stub = new org.glite.security.voms.VOMSAdminSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.glite.security.voms.VOMSAdmin.class.isAssignableFrom(serviceEndpointInterface)) {
                org.glite.security.voms.VOMSAdminSoapBindingStub _stub = new org.glite.security.voms.VOMSAdminSoapBindingStub(new java.net.URL(VOMSAdmin_address), this);
                _stub.setPortName(getVOMSAdminWSDDServiceName());
                return _stub;
            }
        }

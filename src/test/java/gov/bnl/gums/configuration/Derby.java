...
public class Derby {
	...
	logger.info("connect to: " + connectionURL);
        ...
        try {
            ...
            dropTableIfExists(conn,"USERDN");

            // now, put in the real tables

            stmt.execute("CREATE TABLE GRIDUSER ( " +
            ...
            stmt.execute("CREATE INDEX COMPLETE1 ON GRIDUSER (GROUP_NAME, DN, FQAN)");
            ...
            stmt.executeUpdate("INSERT INTO GRIDUSER (DN,GROUP_NAME) VALUES " +
                    "('" + user + "', 'admins')");

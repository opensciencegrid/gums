...
public class Derby {
	...
	logger.info("connect to: " + connectionURL);
        ...
        try {
            ...
            stmt.execute("CREATE TABLE USERDN ( " +
            ...
            stmt.execute("CREATE INDEX COMPLETE1 ON USERDN (GROUP_NAME, DN, FQAN)");
            ...
            stmt.executeUpdate("INSERT INTO USERDN (DN,GROUP_NAME) VALUES " +
                    "('" + user + "', 'admins')");

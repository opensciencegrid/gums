...
//        factory.addMapEntry("/DC=org/DC=griddev/OU=People/CN=John Smith", "grid002", "test", "map=test,ou=GUMS");
    }

    public void testAddUserSecondaryGroupEntry() {
//    	factory.addToSecondaryGroup("grid001", "test");

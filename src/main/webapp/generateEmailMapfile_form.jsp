...
Generates the email-mapfile relative to the given service.
</p>

<form action="generateEmailMapfile.jsp" method="get">
 ...
 size="64" name="host"><br>
      ...
      <tr>
        ...
        <div style="text-align: center;"><button type="submit">generate email-mapfile</button></div>
        </td>
      </tr>
    </tbody>
  </table>

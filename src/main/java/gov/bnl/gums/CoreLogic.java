...
public class CoreLogic {
    private Log log = LogFactory.getLog(CoreLogic.class); // only use this log for particularly tricky aspects of this class - otherwise log within lower level classes
